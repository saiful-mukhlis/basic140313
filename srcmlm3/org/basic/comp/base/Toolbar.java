...
//		}
		...
		login=new JButton();
		setButton2(db, login, LApp.iconLogin16);
		login.setBackground(Color.WHITE);
		
		exit=new JButton();
		setButton2(db, exit, LApp.iconExit16);
		...
		blogin=new JButton();
		setButton2(db, blogin, "Login", LApp.iconLogin32);
		blogin.setBackground(Color.WHITE);
		
		bexit=new JButton();
		setButton2(db, bexit, "Exit", LApp.iconExit32);
		...
		reg=new JButton();
		setButton2(db, reg, "Registration", LApp.iconReg32);
		reg.setBackground(Color.WHITE);
		
		about=new JButton();
		setButton2(db, about, "About", LApp.iconInfo32);
